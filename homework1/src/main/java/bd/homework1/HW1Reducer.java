...
/**
 * Reducer:
 * - adds all bytes from mapper (each one count is 1), outs sum
 * - adds all requests count received from mapper, outs overall requests count from concrete IP
 * - outs average bytes count received from concrete IP
 */
