...
public class MapReduceTest {
    private MapDriver<Object, Text, Text, DataWritable> mapDriver;
    private ReduceDriver<Text, DataWritable, Text, DataWritable>  combinerDriver,
            reduceDriver;
    private MapReduceDriver<Object, Text, Text, DataWritable, Text, DataWritable> mapReduceDriver;
    ...
    public void testMapper() throws IOException {
        mapDriver.withInput(new LongWritable(), new Text(testIP))
                .withOutput(new Text("3.167.108.238"), new DataWritable(new FloatWritable(0.0f), new IntWritable(2701), new IntWritable(1)))
                .runTest();
    }
    @Test
    public void testCombiner() throws IOException {
        List<DataWritable> values = new ArrayList<DataWritable>();
        values.add(new DataWritable(new FloatWritable(0.0f), new IntWritable(2701), new IntWritable(1)));
        combinerDriver
                .withInput(new Text("3.167.108.238"), values)
                .withOutput(new Text("3.167.108.238"), new DataWritable(new FloatWritable(0), new IntWritable(2701), new IntWritable(1)))
                .runTest();
    }
    @Test
    public void testReducer() throws IOException {
        ...
        reduceDriver
                .withInput(new Text("3.167.108.238"), values)
                .withOutput(new Text("3.167.108.238"), new DataWritable(new FloatWritable(2701.0f), new IntWritable(2701), new IntWritable(1)))
                .runTest();
    }
    @Test
    public void testMapReduce() throws IOException {
        mapReduceDriver
                ...
                .withInput(new LongWritable(), new Text(testIP))
                .withInput(new LongWritable(), new Text(testIP))
                .withOutput(new Text("3.167.108.238"), new DataWritable(new FloatWritable(2701.0f), new IntWritable(2701*3), new IntWritable(3)))
                .runTest();
    }
